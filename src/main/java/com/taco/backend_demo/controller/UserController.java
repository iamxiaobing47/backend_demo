...
//                    loginUserInfo.getUsername(),  // email
//                    loginUserInfo.getUsername(),  // username
//                    loginUserInfo.getRole(),
//                    loginUserInfo.getBusinessOwnerId(),
//                    loginUserInfo.getLocationId()
//            );
//
...
//            userInfo.setRole(loginUserInfo.getRole());
//            userInfo.setBusinessOwnerId(loginUserInfo.getBusinessOwnerId());
//            userInfo.setLocationId(loginUserInfo.getLocationId());
//
//            return ResponseFactory.success(userInfo, NotificationMessageCodes.N025);
//        }
