...
public class AuthController {
    ...
    public ResponseEntity<Response<LoginResponse>> login(@RequestBody LoginRequest request, HttpServletRequest httpRequest) {
        ...
        response.setRefreshExpiresIn(jwtUtils.getRefreshExpirationTime());

        return ResponseFactory.success(response, NotificationMessageCodes.N020);
    }
    ...
    public ResponseEntity<Response<LoginResponse>> refreshToken(@RequestBody RefreshTokenRequest request) {
        ...
        return ResponseFactory.success(response, NotificationMessageCodes.N023);
    }
